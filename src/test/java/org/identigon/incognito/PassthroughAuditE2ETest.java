...
class PassthroughAuditE2ETest {
    ...
    void opaqueKeptColumnsAreFlagged() throws Exception {
        ...
        PipelineResult result = IncognitoPipeline.builder()
            ...
            .stage(new org.identigon.incognito.core.SchemaDiscoveryStage())
            .stage(new org.identigon.incognito.core.TableTransformLoadStage())
            .stage(new org.identigon.incognito.core.VerificationStage())
            .build().execute();
